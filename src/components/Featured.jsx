...
const Featured = () => {
  return (
    <section className="bg-base-100 py-16 px-4 md:px-10">
      <div className="max-w-7xl mx-auto px-4 text-base-content">
        <h2
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div
            className="p-6 shadow-md rounded-xl bg-base-200 text-center hover:shadow-xl transition-shadow duration-300"
            data-aos="fade-up"
            data-aos-delay="100"
